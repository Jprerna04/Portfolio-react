                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="p-6 bg-gray-100 sm:rounded-lg">
                    ...
                    <p className="text-lg sm:text-xl font-medium text-gray-600 mt-2">
                      Always eager to discuss fresh ideas, exciting projects, or upcoming networking opportunities.
                      Let’s connect!!
                    </p>
                    ...
                    <div className="flex items-center mt-6 text-gray-600">
                      ...
                      <div className="ml-4 text-md tracking-wide font-semibold w-40">Delhi, India</div>
                    </div>
                    ...
                    <div className="flex items-center mt-4 text-gray-600">
                      ...
                      <div className="ml-4 text-md tracking-wide font-semibold w-40">+91 9871446143</div>
                    </div>
                    ...
                    <div className="flex items-center mt-2 text-gray-600">
                      ...
                      <div className="ml-4 text-md tracking-wide font-semibold w-40">prernajha267@gmail.com</div>
                    </div>
                  </div>
                  ...
                  <form className="p-6 flex flex-col justify-center">
                    ...
                    <button
                      type="submit"
                      className="md:w-32 bg-blue-950 hover:bg-blue-dark text-white font-bold py-3 px-6 rounded-lg mt-3 hover:bg-blue-900 transition ease-in-out duration-300"
                    >
                      SEND
                    </button>
                  </form>
